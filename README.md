...
## Prerequisites
Download [MIMIC-III](https://physionet.org/content/mimiciii/1.4/) data and [MIMIC-II](https://archive.physionet.org/mimic2/) data. 
...
python3 dkae/data/mimic2_data_preparer.py \
    --data_output_dir=your_data_dir \
    --pre_process_level=level_1 \
    --segment_text=True 
