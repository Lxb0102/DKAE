...
class MimicIIIDataset(Dataset):
    def __init__(self, data):
        self.input_ids = data["input_ids"]              # <class 'tuple'>
        self.attention_mask = data["attention_mask"]    # <class 'tuple'>
        self.token_type_ids = data["token_type_ids"]    # <class 'tuple'>
        self.labels = data["targets"]                   # <class 'list'>

    def __len__(self):
        return len(self.input_ids)

    def __getitem__(self, item):
        # print("input_ids: ", len(self.input_ids), type(self.input_ids))
        # print("attention_mask: ", len(self.attention_mask), type(self.attention_mask))
        # print("token_type_ids: ", len(self.token_type_ids), type(self.token_type_ids))
        # print("labels: ", len(self.labels), type(self.labels))
        return {
