...
from models.modeling import CodingModel, CodingModelConfig
from models.utils import initial_code_title_vectors, calculate_scores, tokenize_dataset, MimicIIIDataset, \
...
def main():
    ...
    file_handler = logging.FileHandler(
        ...
        os.path.join('/root/autodl-fs/HiLAT-main/hilat/model', "log_{}.txt".format(now)))
